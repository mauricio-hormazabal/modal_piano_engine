...
class AudioEngine:
    def __init__(self, fs=44100, blocksize=512, use_soft_clip=False):
        #self.audio_capture = []  # ← aquí acumulamos los buffers
